...
print(f'\nResNet50 Test Accuracy: {test_accuracy:.4f}')
model.save('glaucoma_model_resnet50.h5')
print('ResNet50 model saved as glaucoma_model_resnet50.h5')
combined_history = {}
for key in history_phase1.history:
    combined_history[key] = history_phase1.history[key] + history_phase2.history[key]
for key in combined_history:
    combined_history[key] = [float(v) for v in combined_history[key]]
with open('results/resnet50_history.json', 'w') as f:
    json.dump(combined_history, f)
print('Training history saved as resnet50_history.json')
