...
# Load the DenseNet121 base architecture pre-trained on ImageNet weights
...
print(f'\nDenseNet121 Test Accuracy: {test_accuracy:.4f}')
model.save('glaucoma_model_densenet.h5')
print('DenseNet121 model saved as glaucoma_model_densenet.h5')
combined_history = {}
...
with open('results/densenet_history.json', 'w') as f:
    json.dump(combined_history, f)
print('Training history saved as densenet_history.json')
